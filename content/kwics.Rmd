...
**[Here](https://mybinder.org/v2/gh/SLCLADAL/interactive-notebooks/tree/main/main?labpath=notebooks%2Fkwics_cb.ipynb)** is a **link to an interactive version of this tutorial on MyBinder.org**. The interactive tutorial is based on a Jupyter notebook of this tutorial. This interactive Jupyter notebook allows you to execute code yourself and you can also change and edit the notebook, e.g. you can change code and upload your own data. <br>
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/SLCLADAL/interactive-notebooks/tree/main/main?labpath=notebooks%2Fkwics_cb.ipynb)<br>
</p>
