...
On this page you see an overview of events such as webinars, panels, and workshops that have been organised or hosted by LADAL. 
...
As LADAL is a member of the [Australian Text Analytics Platform (ATAP)](https://www.atap.edu.au), all LADAL events are co-hosted by [ATAP](https://www.atap.edu.au). 

[ATAP](https://www.atap.edu.au) offers various events and engagement opportunities. Please see the [**ATAP events page**](https://www.atap.edu.au/events/)  for more details about upcoming and past ATAP events. 
...
1.	Outline the necessary preparation and preconditions for using computational approaches to text.

2.	Introduce you to the R programming language with Jupyter notebooks. 

3.	Guide you through using a series of common methods and libraries in R so you can start asking the right questions for your own projects. 

4.	Tie everything back together with a discussion of the practical aspects of managing projects with computational components grounded in our research experiences.

## Conference workshop *Text Analytics for Humour Studies*{-}

Date: 9 February 2024

Context: [Australian Humour Network 2024 Conference](https://ahsnhumourstudies.org/wp-content/uploads/AHSN-Conference-Booklet_UQ_7-9Feb2024_final-2.pdf) 
...
## AcqVA Aurora Workshop *Advanced Dimension-Reduction Methods and Using  Online Computing for Transparent Research*{-}
...
## ResBazQld workshop *Unlock the power of text analytics with LADAL*{-}
...
## AcqVA Aurora workshop *Dimension Reduction Methods for Linguistic Data Analysis*{-}

Date: 25 August 2023

Context: AcqVA Aurora workshop

Resources: [GitHub Repo](https://github.com/MartinSchweinberger/AcqVA_DimRedR_WS), [intercative Jupyter notebook](https://mybinder.org/v2/gh/MartinSchweinberger/AcqVA_DimRedR_WSIA/main?labpath=acqvadimredws_cb.ipynb)
...
## AcqVA Aurora workshop: From Tables to Forests{-}
