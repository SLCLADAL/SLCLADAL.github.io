...
Since Text Analysis encompasses compasses computational methods, it can be considered a derivative of computational linguistics that applies methods from *Natural Language Processing* (NLP). As such, Text Analysis represents the application of computational methods in the humanities and thus falls within computational humanities research. 
