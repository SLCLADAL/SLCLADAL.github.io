...
<p style='margin-top:1em; text-align:center'>
Click on this [![Binder](https://mybinder.org/badge_logo.svg)](https://binderhub.atap-binder.cloud.edu.au/v2/gh/SLCLADAL/interactive-notebooks-environment/main?urlpath=git-pull%3Frepo%3Dhttps%253A%252F%252Fgithub.com%252FSLCLADAL%252Finteractive-notebooks%26urlpath%3Dlab%252Ftree%252Finteractive-notebooks%252Fnotebooks%252Fpostool.ipynb%26branch%3Dmain) badge to open an notebook-based tool <br> that allows you upload your own text(s), pos-tag them and download the resulting pos-tagged texts. </p><br>
<p style='margin-left:1em;'>
</p></span>
</div>
