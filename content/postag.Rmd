...
Schweinberger, Martin. `r format(Sys.time(), '%Y')`. *Part-of-Speech Tagging and Dependency Parsing with R*. Brisbane: The University of Queensland. url: https://slcladal.github.io/postag.html (Version `r format(Sys.time(), '%Y.%m.%d')`).

```
@manual{schweinberger`r format(Sys.time(), '%Y')`postag,
