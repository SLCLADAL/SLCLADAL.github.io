...
Collocations are combinations of words that frequently co-occur in a language, appearing together more often than would be expected by chance. We need to differentiate between  
...
assoc_tb2 %>%
  ...
  ggplot(aes(x = reorder(token, AM, mean), y = AM)) +
