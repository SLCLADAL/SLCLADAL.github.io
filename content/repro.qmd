...
knitr::include_graphics("https://slcladal.github.io/content/images/rmd02.png")
```

```{r rmd01, echo=FALSE, out.width= "100%", out.extra='style="float:right; padding:10px"'}
knitr::include_graphics("https://slcladal.github.io/content/images/rmd01.png")
```


```{r rmd03, echo=FALSE, out.width= "100%", out.extra='style="float:right; padding:10px"'}
knitr::include_graphics("https://slcladal.github.io/content/images/rmd03.png")
```


```{r rmd04, echo=FALSE, out.width= "100%", out.extra='style="float:right; padding:10px"'}
knitr::include_graphics("https://slcladal.github.io/content/images/rmd04.png")
```
