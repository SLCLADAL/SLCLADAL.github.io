...
This tutorial shows how to perform document classification using R. The entire R markdown document for the tutorial can be downloaded [here]("https://slcladal.github.io/content/atap_docclass.Rmd").
...
```{r fulltexttoks}
toks <- quanteda::tokens(fulltext, remove_punct = TRUE)
```
