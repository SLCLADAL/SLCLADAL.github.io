...
* **ICE Ireland**: `http://www.martinschweinberger.de/docs/data/ICE-Ireland.zip`
* **BROWN**: `http://www.martinschweinberger.de/docs/data/BROWN2.zip`
* **INNSBRUC**: `http://www.martinschweinberger.de/docs/data/INNSBRUC.zip`
...
* Your graphics should ideally look like this: 

```{r fig.width=8, fig.height=6, echo=FALSE, warning=FALSE}
library(png)
ima <- readPNG("resources/SW-Reg.png")
...
```{r fig.width=8, fig.height=6, echo=FALSE, warning=FALSE}
library(png)
ima <- readPNG("resources/SW-Sex.png")
plot(c(100, 250), c(300, 450), type = "n", xlab = "", ylab = "", xaxt = "n",yaxt = "n")
lim <- par()
rasterImage(ima, lim$usr[1], lim$usr[3], lim$usr[2], lim$usr[4])
```
...
```{r fig.width=8, fig.height=6, echo=FALSE, warning=FALSE}
library(png)
ima <- readPNG("resources/SW-AgeSex.png")
plot(c(100, 250), c(300, 450), type = "n", xlab = "", ylab = "", xaxt = "n",yaxt = "n")
lim <- par()
rasterImage(ima, lim$usr[1], lim$usr[3], lim$usr[2], lim$usr[4])
```
...
```{r fig.width=8, fig.height=6, echo=FALSE, warning=FALSE}
library(png)
ima <- readPNG("resources/ment1.png")
plot(c(100, 250), c(300, 450), type = "n", xlab = "", ylab = "", xaxt = "n",yaxt = "n")
lim <- par()
rasterImage(ima, lim$usr[1], lim$usr[3], lim$usr[2], lim$usr[4])
```
