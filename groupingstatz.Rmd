...
As is the tutorial on Semantic Vector Space Models, we will we investigate similarities among amplifiers based on their co-occurrences (word embeddings) with adjectives. To this end, we continue with the simplified `vsmdata` (`vsmdata_simp`).

## Preparation{-}

We start by loading the required packages and by inspecting the simplified `vsmdata` (`vsmdata_simp`)
