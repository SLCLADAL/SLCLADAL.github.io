---
title: "Classification and Clustering with R"
...
This tutorial introduces classification and clustering using R. The entire code for the sections below can be downloaded [here](https://slcladal.github.io/rscripts/classificationscript.r). 
...
```{r ca1, eval = F, echo=F, message=FALSE, warning=FALSE}
# load libraries
library("FactoMineR")
library("factoextra")
...
Schweinberger, Martin. 2020. *Classification and Clustering with R*. Brisbane: The University of Queensland. url: https://slcladal.github.io/groupingstatz.html.
