...
```{r staff2, echo=FALSE, out.width= "25%", out.extra='style="float:centre; padding:10px"'}
knitr::include_graphics("https://slcladal.github.io/images/people_erich.png")
```

<br> 

+ [Erich Round](https://researchers.uq.edu.au/researcher/1761) is a senior lecturer in linguistics at UQ, and from 2021 is a British Academy Global Professor in linguistics at the University of Surrey, UK.
...
```{r staff3, echo=FALSE, out.width= "25%", out.extra='style="float:centre; padding:10px"'}
knitr::include_graphics("https://slcladal.github.io/images/people_stephane.png")
```

<br> 

+ [Stephane Guillou](https://gitlab.com/stragu) is the leading proponent of computational up-skilling at the UQ library
