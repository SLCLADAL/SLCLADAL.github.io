...
As ceratures of habit, we focus on certain things while we ignore others. This is quite helpful to orient ourselves ina highly complex world but it is unfortuantely quite detremental to the scientific endevour. This is particularly so as we tend to ignore things or ideas that do not match our expectations. So, rather than finding evidence for 
