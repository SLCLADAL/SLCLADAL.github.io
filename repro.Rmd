...
Below is an example for how you can load, process, and save your data as .rda in R Studio.
...
# save data
base::save(lmm, file = "data/lmm.rda")
# test
rm(lmm)
# load .rda data
...
Schweinberger, Martin. 2020. *Data Management, Version Control, and Reproducibility*. Brisbane: The University of Queensland. url: https://slcladal.github.io/repro.html (Version 2020.12.03).

```
@manual{schweinberger2020repro,
