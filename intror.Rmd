---
title: "A Basic Introduction To R"
...
library(png)
ima <- readPNG("resources/RStudioscreenshot.png")
...
We have now added the argument `col = "red"` which tells the plot function that you want the lines in the line graph to be coloured in red.
