...
```{r data1, eval=T, message=FALSE, warning=FALSE}
...
```{r scatter 3, echo = T, results = 'asis', message=FALSE, warning=FALSE}
data03 <- read.delim("https://slcladal.github.io/data/data03.txt", sep = "\t", header = T)
data03
```

```{r scatter4, , echo = F, eval = F, message=FALSE, warning=FALSE}
data03 <- read.delim("https://slcladal.github.io/data/data03.txt", sep = "\t", header = T)
