...
# inspect data
ft <- flextable(likertdata)
ft <- set_caption(ft,
                  caption = "Overview of the likertdata.")
ft <- autofit(ft)
# inspect data
ft
```
...
# inspect data
ft <- flextable(bardata)
ft <- set_caption(ft,
                  caption = "Overview of the bardata.")
ft <- autofit(ft)
# inspect data
ft
```
...
Schweinberger, Martin. 2020. *Common Visualization Types in R*. Brisbane: The University of Queensland. url: https://slcladal.github.io/basicgraphs.html (Version 2020.12.03).
