...
```{r data3, echo = T, eval=T, message=FALSE, warning=FALSE}
# attach plotdata
attach(plotdata)
```
...
In tabulated form the first 6 rows of the reduced data looks like shown below:

```{r data6, echo = F, eval=T, message=FALSE, warning=FALSE}
library(knitr)
kable(head(plotdataredux), caption = "First 6 rows of plotdataredux")
```
