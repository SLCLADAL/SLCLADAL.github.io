...
We will now continue with generating the dictionary based on the brothers' Grimm fairy tales. We go through the same steps as for the English dictionary and collapse all the steps into a single code block. 
