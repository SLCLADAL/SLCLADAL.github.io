...
There are two main methods for tracking changes in polarity: binning and moving averages. Binning splits the data up into sections and calculates the polarity ratios within each bin. Moving averages calculate the mean within windows that are then shifted forward. We begin with an exemplification of binning and then move on to calculating moving averages. 
