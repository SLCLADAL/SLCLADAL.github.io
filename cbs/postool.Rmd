...
<span>
<p style='margin-top:1em; text-align:center'>
The code chunk below assumes that you want to pos-tag English text(s). \n If you want to pos-tag text in another language, replace "english-ext" with another pre-trained language model,\n e.g. "german-gsd" for pos-tagging a German text (see above for available models).
<br>
</p>
<p style='margin-left:1em;'>
</p></span>
