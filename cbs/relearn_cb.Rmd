...
This tutorial introduces the concept of Reinforcement Learning , and how it can be applied in the domain of Natural Language Processing and linguistics.The code for this tutorial is provided in the following link. [here](https://slcladal.github.io/reinfnlp.Rmd). 
