...
This tutorial shows how to get started with R and it specifically focuses on R for analyzing language data. The R markdown document for this tutorial can be downloaded [here](https://slcladal.github.io/Intror.Rmd). If you already have experience with R, both(see [here](https://r4ds.had.co.nz/)) and (see [here](https://bookdown.org/csgillespie/efficientR/)) are highly recommendable and excellent resources for improving your coding abilities and workflows in R.
