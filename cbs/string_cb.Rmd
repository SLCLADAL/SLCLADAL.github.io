...
![String Processing in R](https://slcladal.github.io/images/uq1.jpg)
...
This tutorial introduces string processing and this can be used when working with language data. The entire (non-interactive) R Notebook for this tutorial below can be downloaded [here](https://slcladal.github.io/string.Rmd). This tutorial is aimed at beginners and intermediate users of R with the aim of showcasing how to work with and process textual data using R. The aim is not to provide a fully-fledged analysis but rather to show and exemplify selected useful functions and methods associated with text processing. 
...
Schweinberger, Martin. 2022. *String processing in R*. Brisbane: The University of Queensland. url: https://slcladal.github.io/string.html.
