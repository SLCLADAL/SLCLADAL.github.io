...
**Please copy this Jupyter notebook so that you are able to edit it.**<br><br>**Simply go to: File > Save a copy in Drive.** <br><br>**If you want to run this notebook on your own computer, please make sure that you have R installed!**<br><br>**Once you have done that, you are good to go.**</p>
...
The clustering provides approximately unbiased p-values and bootstrap probability value (cf. Levshina 2015: 316).
...
Schweinberger, Martin. 2021. *Cluster and Correspondence Analysis in R*. Brisbane: The University of Queensland. url: https://slcladal.github.io/clust.html.
...
Blashfield, Roger K, and Mark S. Aldenderfer. 1988. The Methods and Problems of Cluster Analysis. In *Handbook of Multivariate Experimental Psychology*, 447–473. Springer.
