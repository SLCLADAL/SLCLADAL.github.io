...
***
> Please copy this Jupyter notebook so that you are able to edit it (otherwise you can run code but you cannot change anything). 
>
> To copy (and then edit the content of the notebook):
> 
