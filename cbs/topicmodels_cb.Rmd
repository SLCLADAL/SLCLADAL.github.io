...
This tutorial is the interactive Jupyter notebook accompanying the [Language Technology and Data Analysis Laboratory (LADAL) tutorial on topic modelling using R](https://slcladal.github.io/topicmodels.html). This tutorial is aimed at beginners and intermediate users of R with the aim of showcasing how to perform topic modeling on textual data  using R. The aim is not to provide a fully-fledged analysis but rather to show and exemplify selected useful methods associated with topic modeling and visualizing results of topic models.
...
Unfortunately the package `topicmodels` has to be installed separately (as shown below).
...
Schweinberger, Martin. 2022. *Topic Modeling with R*. Brisbane: The University of Queensland. url: https://slcladal.github.io/topicmodels.html.
