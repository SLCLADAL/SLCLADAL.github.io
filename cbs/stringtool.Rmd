...
This notebook-based tool accompanies the [*Language Technology and Data Analysis Laboratory* (LADAL) tutorial *String Processing in R*](https://ladal.edu.au/coll.html). 


**Preparation and session set up**

We start by setting options (suppressing warning messages) and activating the packages we need. 
