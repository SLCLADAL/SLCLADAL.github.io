...
This tutorial introduces Text Similarity , i.e. how close or similar two pieces of text are with respect to either their use of words or characters (lexical similarity) or in terms of meaning (semantic similarity). The entire code for the sections below can be downloaded [here](https://slcladal.github.io/lexsim.Rmd). 
