...
The code chunk below allows you to browse to and upload your own data (a single txt file).

```{r loadown, echo = T, eval = F, message=FALSE, warning=FALSE}
mytext1 <- scan(file = "https://drive.google.com/file/d/1CF04Q-0liMqGy20Gn3muw6AEd3_gVXWn/view?usp=sharing",
            what = "char", 
            sep = "", 
            quote = "", 
            quiet = T, 
            skipNul = T)
mytext2 <- scan(file = "https://drive.google.com/file/d/12NLIljNcsZzKhSGyTJFKdwb8YMZn_uIm/view?usp=sharing",
            what = "char", 
            sep = "", 
            quote = "", 
            quiet = T, 
