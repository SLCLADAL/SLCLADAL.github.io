...
![Data format required for this notebook](https://slcladal.github.io/images/netdata.png){width=200px height=200px}
...
+ `n_min`: minimum label size (default = 2),   
+ `n_max`: maximum label size (default = 4),  
...
# plot the network
netplot(x = ed, edge_col = "gray80", edge_curv= .2, node_tran = .2, n_min = 2, n_max = 4, n_col = "gray10")
```
