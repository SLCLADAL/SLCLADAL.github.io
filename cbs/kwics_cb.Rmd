...
```{r antc1, echo=FALSE, out.width= "70%", out.extra='style="float:left; padding:2px"', fig.cap="\\label{fig:Fig1} Concordances in AntConc."}
knitr::include_graphics("https://slcladal.github.io/images/AntConcConcordance.png")
```

There are various very good software packages that can be used to create concordances - both for offline use (e.g. [*AntConc*](https://www.laurenceanthony.net/software/antconc/) , [*SketchEngine*](https://www.sketchengine.eu/), [*MONOCONC*](https://www.monoconc.com/), and [*ParaConc*](https://paraconc.com/)) and online use (see e.g. [here](https://lextutor.ca/conc/)). 
...
```{r coca1, echo=FALSE, out.width= "70%", out.extra='style="float:right; padding:2px"', fig.cap="\\label{fig:Fig2} Online concordances extracted from the COCA corpus that is part of the BYU corpora."}
...
For this tutorial, we will use Charles Darwin's *On the Origin of Species by means of Natural Selection* which we download from the [Project Gutenberg](https://www.gutenberg.org/) archive . Thus, Darwin's *Origin of Species* forms the basis of our analysis. You can use the code below to download this text into R (but you have to have access to the internet to do so).
