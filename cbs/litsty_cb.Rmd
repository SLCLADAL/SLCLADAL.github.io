...
While this tutorial builds on(see [here](https://www.tidytextmining.com/)), it substantially expandsin terms of the range of methods that are presented and the data sources that are used.
...
Zipf's Law represents an empirical power law or power function that was established in the 1930s. Zipf's law is one of the most fundamental laws in linguistics  and it states that the frequency of a word is inversely proportional to its rank in a text or collection of texts. 
