...
For a network visualization, you need at least one table indicating the start and end points of edges (lines connecting nodes). Additionally, two additional tables providing information on node size/type and edge size/type are valuable. 

The default that that we provide represents the frequency of characters in William Shakespeare's *Romeo and Juliet* appearing in the same scene. 
