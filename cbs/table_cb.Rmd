...
This tutorial introduces tables and shows how to tabulate data. The entire R markdown document for this tutorial can be downloaded [here](https://slcladal.github.io/table.Rmd). A truly excellent and highly recommendable resource on processing data in R is[see alsoAlternative but also very useful resources areand 
