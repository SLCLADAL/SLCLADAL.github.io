...
Now that the topic model has been generated, we can inspect what trems correlate most stronly with which topic. The code chunk below will show the top 10 terms for each topic.
