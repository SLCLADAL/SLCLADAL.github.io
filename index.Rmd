...
To see and show what people use LADAL resources for, we are currently looking for *user stories* ( also known as *testimonials*). If you have used LADAL resources - be it by simply copying some code, attending a workshop, learning about a method using a tutorial, or in any other way, we would be extremely grateful, if you could send us your user story! Simply write up a paragraph describing how you have used LADAL resources and what you have used it for and send it to slcladal\@uq.edu.au. We really appreciate any feedback from you about this!
