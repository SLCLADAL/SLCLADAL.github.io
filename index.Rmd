...
The tutorials in the "Data processing" section introduce R as an language technology environment and show how to handle language data.

The section "Visualization" shows how to create graphs from very simple plots to quite sophisticated visualizations.

The "Statistics" tutorials focus on how to sumarize and analyze data using statistical methods.

"Text Analysis/Corpus Linguistics" exemplifies how to use R for Text Analysis but also provides links to software that are useful when you do not want to use R.
