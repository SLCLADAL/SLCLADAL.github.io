...
```{r dataviz, echo=FALSE, out.width= "40%", out.extra='style="float:left; padding:15px"'}
...
```{r aud1, echo=FALSE, out.width= "50%", out.extra='style="float:right; padding:15px"'}
...
```{r rs, echo=FALSE, out.width= "20%", out.extra='style="float:left; padding:15px"'}
...
```{r uqcampus, echo=FALSE, out.width= "50%", out.extra='style="float:right; padding:15px"'}
