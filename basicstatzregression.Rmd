...
The idea behind regression analysis is expressed formally in [equation](#eq:slm) and can best be described graphically: Imagine drawing a line through points in a scatterplot (left panel figure).
