...
# install libraries
install.packages(c("Hmisc", "tidyverse", "zoo", "sentimentr"))
```
...
Schweinberger, Martin. 2020. *Sentiment Analysis in R*. Brisbane: The University of Queensland. url: https://slcladal.github.io/sentiment.html (Version 2020.12.03).
