...
This section focuses on how to perform a corpus analyses using `R`. The first example will answer the question of whether men or woemn swaer more (in Irish English) while the second analysis will investigate the use of adjectival amplifiers in Australian English.

# Example 1: Gender Differences in Swearing

```{r swearing1, echo=F, message=FALSE, warning=FALSE, results=}
