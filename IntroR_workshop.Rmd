...
* You can load the Rmd-file in RStudio, **create a new Rmd-file** (or Notebook) and then copy and paste the code snippets in this new Rmd-file and execute them as we go.
...
Before you actually open R or RStudio, there things to consider that make working in R much easier and give your workflow a betteRStructure. 
...
## FoldeRStructure and R projects{-}
...
+ do not want R to automatically convert characteRStrings to be converted into factors
...
Schweinberger, Martin. 2020. *Getting started with R - for (absolute) beginners*. Brisbane: The University of Queensland. url: https://slcladal.github.io/introquant.html (Version 2020.12.03).


```
@manual{schweinberger2020intr,
  author = {Schweinberger, Martin},
  title = {Getting started with R - for (absolute) beginners},
  note = {https://slcladal.github.io/IntroR_workshop.html},
  year = {2020},
