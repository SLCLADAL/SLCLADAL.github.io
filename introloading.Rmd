...
# Loading and Exporting Data in R

In this section, we will deal with how to import data into "R" and how to export results from "R". In addition, we will have a look at how to set the "workspace" and why this makes sense when working in R.
