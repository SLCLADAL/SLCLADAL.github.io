...
[Martin Hilpert](https://unine.academia.edu/MartinHilpert) has created a [very recommendable screen-cast tutorial](https://www.youtube.com/watch?v=Z6NYQdiwTrU) on how to create motion charts in R.
...
```{r mc23, message=FALSE, warning=FALSE}
# create motion chart
...
```{r mc25, eval = F, message=FALSE, warning=FALSE}
plot(MC)
```
...
Schweinberger, Martin. 2020. *Creating Interactive Visualization in R*. Brisbane: The University of Queensland. url: https://slcladal.github.io/motion.html (Version 2020.12.03)
