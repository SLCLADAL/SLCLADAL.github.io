...
We can now display the motion chart using the `plot` function.
...
```{r mot3, echo=F, eval = F, fig.cap="", message=FALSE, warning=FALSE, out.width='100%'}
...
We now turn to a linguistic example. The phenomenon we will use Linguistic Example: which verbs take which complement clause type?
