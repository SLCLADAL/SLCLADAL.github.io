...
sentences <- c("This is a first sentence.", 
...
Schweinberger, Martin. 2020. *String processing in R*. Brisbane: The University of Queensland. url: https://slcladal.github.io/string.html (Version 2020.12.12).

```
@manual{schweinberger2020string,
