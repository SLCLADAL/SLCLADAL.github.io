...
This tutorial introduces how to extract and process text data from social media sites, web pages, or other documents for later analysis. Parts of this tutorial builds on and uses from  @wiedemann2017textmining. The entire code for the sections below can be downloaded [here](https://slcladal.github.io/rscripts/webcrawlingrscript.r). 
