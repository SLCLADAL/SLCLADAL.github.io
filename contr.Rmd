...
An even better option than merely reporting it is to fix the bug via GitHub. That way, we receive an email that someone found an error and has submitted a fix which we can then review and accept. Below is a detailed description of how exactly you can do that.

# Becoming a LADAL contributor{-}

If you have an idea for a tutorial, you can download this skeleton Rmd and include your tutorial. 
