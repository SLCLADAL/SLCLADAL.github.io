...
Again, we can customize the map according to what we want. 
...
In addition, we load a map with a higher resolution using the `ne_countries` function from the `rnaturalearth` package.
