...
Schweinberger, Martin. 2021. *Displaying Geo-Spatial Data with R*. Brisbane: The University of Queensland. url: https://slcladal.github.io/maps.html  (Version `r format(Sys.time(), '%Y.%m.%d')`).
