...
```{r imap1a, echo=T, eval = T, message=FALSE, warning=FALSE}
# load library
library(googleVis)
...
```{r imap1b, echo=T, eval = F, message=FALSE, warning=FALSE}
...
```{r imap4a, echo=T, eval = F, message=FALSE, warning=FALSE}
...
```{r imap4b, echo=T, eval = F, message=FALSE, warning=FALSE}
# display motion chart
print(Geo, 'chart')
```
