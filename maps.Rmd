...
In a first step, the work space is cleared, the options are set, and the relevant libraries are loaded.
...
```{r shp12, echo=T, eval = T, message=FALSE, warning=FALSE}
# load shape file
...
# load shape files
ausstates <- readOGR(dsn = "https://slcladal.github.io/data/shapes/Ashmore and Cartier Islands_AL4-AL4.shp", stringsAsFactors = F)
ausstatesadmin <- readOGR(dsn = "https://slcladal.github.io/data/shapes/Australia_admin_6.shp", stringsAsFactors = F)
...
# load library
#library(ggsn)
# cerate data frame with longitude and latitude values
...
#  geom_path(data=mypolygon,aes(x=Longitude,y=Latitude),
#            colour="white",alpha=0.8,size=2) +
