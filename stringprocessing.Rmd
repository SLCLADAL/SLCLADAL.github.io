...
This section focuses string processing and this can be used when working with language data. The entire code for the sections below can be downloaded [here](https://slcladal.github.io/rscripts/stringprocessingrscript.r).
