...
The first, and simplest graph, is a so-called *scatter* or *dot plot*. Scatterplots are used when the graph is set up to display the relationship between two numeric variables. We will start off with creating a scatter plot in *base*, then in *lattice* and finally in the *ggplot* environment.
...
Schweinberger, Martin. 2020. *Data Visualization with R*. Brisbane: The University of Queensland. url: https://slcladal.github.io/dviz.html (Version 2020.12.12).

```
@manual{schweinberger2020dviz,
