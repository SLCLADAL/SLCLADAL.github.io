...
This tutorial introduces different types of data visualization. The entire R-markdown document for the tutorial can be downloaded [here](https://slcladal.github.io/dviz.Rmd).  A more in-depth and highly recommendable resource for data visualization in R is @wickham2016ggplot2. A more general introduction to data visualization - which is still highly recommendable is @healy2018data.
...
# install libraries
install.packages(c("knitr", "lattice", "tidyverse", 
                   "likert", "scales", "vcd", "tm", "ggridges", 
...
```{r prep4}
# load data
pdat <- read.delim("https://slcladal.github.io/data/lmmdata.txt", header = TRUE) %>%
...
```{r prep5, echo = F}
DT::datatable(pdat, rownames = FALSE, filter="none", caption = "Overview of the data set.", 
...
```{r scatter 3, eval = T,  results = 'asis', message=FALSE, warning=FALSE}
# load data03
...
```{r llik_03, echo = F}
DT::datatable(ldat, rownames = FALSE, filter="none", caption = "Overview of the data set.", 
              options = list(pageLength = 10, scrollX=T))
```
...
```{r pie_02, echo = F}
DT::datatable(bdat, rownames = FALSE, filter="none", caption = "Overview of the data set.", 
              options = list(pageLength = 10, scrollX=T))
```
...
```{r pie_10, echo = F}
DT::datatable(piedata, rownames = FALSE, filter="none", caption = "Overview of the editeddata set.", 
              options = list(pageLength = 10, scrollX=T))
```
...
```{r likert2, echo = F}
DT::datatable(sdat, rownames = FALSE, filter="none", caption = "Overview of survey data.", 
              options = list(pageLength = 10, scrollX=T))
```
...
```{r likert11, echo = F}
DT::datatable(survey, rownames = FALSE, filter="none", caption = "Overview of edited survey data.", 
              options = list(pageLength = 10, scrollX=T))
```
...
```{r wc2, eval = T,  message=FALSE, warning=FALSE}
...
```{r wc3, eval = T,  message=FALSE, warning=FALSE}
# clean texts
...
```{r bar_04, echo = F}
DT::datatable(assocmx, rownames = T, filter="none", caption = "Overview of the matrix.")
```
...
```{r heat_03, echo = F}
DT::datatable(heatmx, rownames = FALSE, filter="none", caption = "Overview of the matrix.", 
              options = list(pageLength = 10, scrollX=T))
```
