...
```{r ea01, eval = F, message=F, warning=F}
# load corpus data
...
```
```{r ea3b, eval = F, echo = F, message=FALSE, warning=FALSE}
# inspect data
text %>%
  as.data.frame() %>%
  head(1) %>%
...
```{r ea04, eval = F, message=F, warning=F}
...
```{r ee6, eval = F, message=FALSE, warning=FALSE}
...
```{r ee6b, eval = F, message=FALSE, warning=FALSE}
# location annotator
...
```{r ee7, eval = F, message=FALSE, warning=FALSE}
# extract features
