...
knitr::include_graphics("Reinforcement.PNG")
```
...
```{r rlartsumm, echo=FALSE, out.width= "60%", out.extra='style="float:center; padding:10px"'}
knitr::include_graphics("deeprlartsumm.PNG")
```
...
```{r dlsimrl, echo=FALSE, out.width= "60%", out.extra='style="float:center; padding:10px"'}
knitr::include_graphics("dlsimrl.PNG")
```
...
knitr::include_graphics("NMT.PNG")
```
