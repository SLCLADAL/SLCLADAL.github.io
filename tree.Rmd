...
```
```{r cit4d,  message=FALSE, warning=FALSE}
# inspect data
citdata %>%
  head(20) %>%
  kable(caption = "First 20 rows of citdata.") %>%
...
```{r rf1b,  message=FALSE, warning=FALSE}
# inspect data
citdata %>%
  head(20) %>%
  kable(caption = "First 20 rows of citdata.") %>%
...
```{r rf3b,  message=FALSE, warning=FALSE}
# inspect data
rfdata %>%
  head(20) %>%
  kable(caption = "First 20 rows of rfdata.") %>%
  kableExtra::kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"), 
                            full_width = F)
```
...
```{r bo1b,  message=FALSE, warning=FALSE}
# inspect data
borutadata %>%
  head(20) %>%
  kable(caption = "First 20 rows of borutadata.") %>%
  kableExtra::kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"), 
                            full_width = F)
```
