...
This tutorial introduces collocation and co-occurrence analysis with "R". It is shown how different significance measures can be used to extract semantic links between words and how such links can be displayed. Parts of this tutorial build on \citep{wiedemann2017textmining}. The entire code for the sections below can be downloaded [here](https://slcladal.github.io/rscripts/networkrscript.r). 
...
# Collocations in Trump's 2020 SOTU address
...
# Tracking collocation change across time
...
```{r coll_02_15, echo=T, eval = T, message=FALSE, warning=FALSE}
