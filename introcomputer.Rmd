...
It is also recommendable to use or create strong passwords. An online test for how strong your password is can be found [here](https://howsecureismypassword.net/) but, as a personal recommendation, I would never paste my password in an online form. An alternative is to use a [password manager](https://www.lastpass.com/business-password-manager).
...
Table 3 should be the easiest to parse and understand. This is so because only Table 3 is *tidy*. To avoid structuring in ways that make it harder to parse, there are three interrelated principles which make a data set tidy:
