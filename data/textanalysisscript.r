...
# Preparation
# install libraries
install.packages(c("class", "cluster", "dplyr", "factoextra", "FactoMineR", "ggplot2", "ggraph", "grid", "gutenbergr", "igraph", "Matrix", "NLP", "openNLP", "openNLPmodels.en", "require(Matrix", "stringr", "syuzhet", "tidyr", "tidytext", "tm", "topicmodels", "wordcloud", "xtable"))
# Concordancing
# load libraries
library(dplyr)
library(stringr)
