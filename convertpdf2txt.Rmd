...
We can now apply the function to the folder in which we have stroed the PDFs. The output is a vector with the texts of the PDFs. 

```{r pconv04, echo=T, eval = T, message=FALSE, warning=FALSE}
# apply function
txts <- convertpdf2txt("data/PDFs/")
# inspect the first txt element
txts[1]
```
