...
If you want be on the LADAL email list and be alerted of any news, updates, openings, and events offered by LADAL or its partner organizations and institutions, simply write an email to ladal@uq.edu.au with the subject **email list**. If you want to unsubscribe, simply send and emial saying **unsubscribe** to ladal@uq.edu.au.
