...
```{r f5}
files5 <- c( "regex.Rmd", "reinfnlp.Rmd", "relearn.Rmd", "rename.Rmd", "repro.Rmd", "rmd2jupyter.Rmd", "sentiment.Rmd")
for (f in files5) rmarkdown::render(f)
```


```{r f6}
files6 <- c("services.Rmd", "sldata.Rmd", "string.Rmd", "support.Rmd", "surveys.Rmd", "svm.Rmd", "table.Rmd", "textanalysis.Rmd", "topicmodels.Rmd")
for (f in files6) rmarkdown::render(f)
```


```{r f7}
files7 <- c("txt2rda.Rmd", "vc.Rmd", "webcrawling.Rmd", "whyr.Rmd")
