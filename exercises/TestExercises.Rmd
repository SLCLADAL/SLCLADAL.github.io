...
ex1data <- read.delim("https://slcladal.github.io/data/lmemdata.txt", sep = "\t", header = T)
head()
```

```{r quiz}
quiz(
  question("What is name of the 7th element in the column called *text* called?",
    answer("austen"),
    answer("bain"),
    answer("benson", correct = TRUE),
    answer("barclay")
  )
)
```
