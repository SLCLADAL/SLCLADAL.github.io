...
The **LADAL Webinar Series 2022** consists of 6 webinars | online presentations from a wide range of voices with backgrounds in linguistics, data science, or computational humanities and it covers topics related to digital handling of language data! All recordings of the webinar series are available on the [LADAL YouTube channel](https://www.youtube.com/channel/UCrPUPT8UvOAxUnorC95-F4Q).
...
## The Spread of Lexical Innovation is Constrained by Cultural Patterns (Jack Grieve){-}
...
knitr::include_graphics("https://slcladal.github.io/images/cq5dam.web.1280.1280.jpeg")
``` 
...
Dr Cedric Courtois is a senior lecturer in the School of Communication and Arts. He is both an audience researcher and a methodologist. His research interests include algorithmic impact in digital culture and data science applications in (digital) media and communication research (including text mining and image processing).
