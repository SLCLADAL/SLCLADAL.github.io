...
knitr::include_graphics("https://slcladal.github.io/images/turo_hiltunen.jpg")
``` 
...
## October 28: Jayden Cordes & Erich Round {-}
...
```{r jayden, echo=FALSE, out.width= "30%", out.extra='style="float:right; padding:10px"'}
knitr::include_graphics("https://slcladal.github.io/images/jayden.jpg")
```
...
```{r erich, echo=FALSE, out.width= "30%", out.extra='style="float:right; padding:10px"'}
knitr::include_graphics("https://slcladal.github.io/images/people_erich.jpg")
```
...
**Recording on YouTube**: https://www.youtube.com/watch?v=QVwWPfxE93U
