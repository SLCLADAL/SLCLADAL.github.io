...
```{r felicity, echo=FALSE, out.width= "45%", out.extra='style="float:right; padding:10px"'}
...
**Corpus_base aAnalyses of Russian morphology (preliminary title)**
...
```{r tanja, echo=FALSE, out.width= "40%", out.extra='style="float:right; padding:10px"'}
