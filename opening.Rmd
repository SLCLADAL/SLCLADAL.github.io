...
<details>
<summary>**An Introduction to AntConc 4: Developing a general-purpose corpus toolkit for a broad user base**</summary>
...
<details>
<summary>**Language variation and change in eighteenth-century publications and publishing networks**</summary>


```{r histana, echo=FALSE, out.width= "45%", out.extra='style="float:right; padding:10px"'}
knitr::include_graphics("https://slcladal.github.io/images/russianforms.png")
``` 
