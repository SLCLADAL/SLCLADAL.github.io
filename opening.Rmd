...
```{r elpis, echo=FALSE, out.width= "40%", out.extra='style="float:right; padding:10px"'}
knitr::include_graphics("https://slcladal.github.io/images/elpis.png")
``` 
...
The recording of Stefan's talk is available [**here**](https://www.youtube.com/watch?v=cLocET9CC-E&t=253s) on the LADAL YouTube channel.
