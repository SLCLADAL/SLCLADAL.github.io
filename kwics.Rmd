...
```{r intro1, fig.width=8, fig.height=6, echo=FALSE, warning=FALSE, fig.cap="\\label{fig:Fig2} KWIC display of the search term language extracted from the BROWN corpus in the program AntConc."}
library(png)
...
```{r intro2, fig.width=8, fig.height=4.5, echo=FALSE, warning=FALSE, fig.cap="\\label{fig:Fig2} Online KWIC display of the search term *language* extracted from the COCA corpus that is part of the BYU corpora."}
library(png)
ima <- readPNG("images/KwicCocaLanguage.png")
plot(c(100, 250), c(300, 450), type = "n", xlab = "", ylab = "", xaxt = "n",yaxt = "n")
lim <- par()
rasterImage(ima, lim$usr[1], lim$usr[3], lim$usr[2], lim$usr[4])
```
