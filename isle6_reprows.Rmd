...
```{r usethis, message=F, warning = F}
library(usethis)
usethis::use_git_config(user.name = "Martin Schweinberger", user.email = "martin.schweinberger.hh@gmail.com")
```
