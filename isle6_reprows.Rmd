...
The *University of Edinburgh* has a comprehensive and easy to follow list (with examples and explanations) of [13 Rules for file naming conventions](https://www.ed.ac.uk/records-management/guidance/records/practical-guidance/naming-conventions) (shown below). You can also use the recommendations of the *Australian National Data Services* (ANDS) [guide of file wrangling](https://www.ands.org.au/working-with-data/data-management/file-wrangling). Some of the suggestions are summarized below.
...
Here are the [13 Rules for file naming conventions](https://www.ed.ac.uk/records-management/guidance/records/practical-guidance/naming-conventions):
