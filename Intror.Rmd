...
Download and inspect the first 7 rows of the data set that you can find under this URL: `https://slcladal.github.io/data/lmm.rda`. Can you guess what the data is about?

```{r, echo = F, eval = F}
ex1data <- base::readRDS(url("https://slcladal.github.io/data/lmm.rda", "rb"))
head(ex1data, 7)
```
