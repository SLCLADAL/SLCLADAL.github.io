...
Using the data called `icebio`, create a new data set called `ICE_Ire_AgeGroup` in which you create a column called `AgeGroup` where all speakers who are younger than 42 have the value *young* and all speakers aged 42 and over *old*. 
