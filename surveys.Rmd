...
```{r bar10, eval = F, echo=T, message=FALSE, warning=FALSE}
# load data
newlikertdata <- read.delim("https://slcladal.github.io/data/lickertdata.txt", header = TRUE)
# inspect data
newlikertdata
```
...
newlikertdata <- likert(newlikertdata)
# inspect data
kable(head(newlikertdata), caption = "First 6 rows of the data") 
```
