...
# load data
ldat <- read.delim("https://slcladal.github.io/data/likertdata1.txt", 
                       sep = "\t", header = TRUE)
```
...
```{r line_01b, echo = F}
DT::datatable(ldat, rownames = FALSE, filter="none", caption = "Overview of the ldat data set.", 
...
```{r pie_02, echo = F}
DT::datatable(bdat, rownames = FALSE, filter="none", caption = "Overview of the bardata.", 
              options = list(pageLength = 10, scrollX=T))
```
...
# create pie chart
ggplot(bdat,  aes("", Percent, fill = Satisfaction)) + 
...
```{r pie_08, echo = F}
DT::datatable(pdat, rownames = FALSE, filter="none", caption = "Overview of the new data.", 
              options = list(pageLength = 10, scrollX=T))
```
...
# create pie chart
ggplot(pdat,  aes("", Percent, fill = Satisfaction)) + 
  geom_bar(stat="identity", width=1, color = "white") +
  coord_polar("y", start=0) +
  scale_fill_manual(values = clrs5) +
  theme_void() +
...
```{r pie_12, echo = F}
DT::datatable(gldat, rownames = FALSE, filter="none", caption = "Overview of the grouped piedata.", 
              options = list(pageLength = 10, scrollX=T))
```
...
# create pie chart
ggplot(gldat,  aes("", Percent, fill = Satisfaction)) + 
  facet_wrap(~Course) +
  geom_bar(stat="identity", width=1, color = "white") +
  coord_polar("y", start=0) +
  scale_fill_manual(values = clrs5) +
...
# bar plot
ggplot(bdat, aes(Satisfaction, Percent, fill = Satisfaction)) +
...
```{r bar_04, echo = F}
DT::datatable(gldat, rownames = FALSE, filter="none", caption = "Overview of the grouped bardata.", 
              options = list(pageLength = 10, scrollX=T))
```
...
ggplot(gldat, aes(Satisfaction, Frequency,  
...
```{r cron_02a, echo = F}
DT::datatable(surveydata, rownames = FALSE, filter="none", caption = "Overview of survey data.", 
              options = list(pageLength = 10, scrollX=T))
```
