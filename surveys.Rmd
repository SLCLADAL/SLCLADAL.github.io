...
ldat %>%
  ...
  flextable::set_caption(caption = "Overview of the ldat data set.")  %>%
...
survey %>%
  ...
  flextable::fontsize(size = 12, part = "header") %>%
  flextable::align_text_col(align = "center") %>%
  flextable::set_caption(caption = "Overview of the edited survey data.")  %>%
  flextable::border_outer()
```
...
newordata %>%
  ...
  flextable::fontsize(size = 12, part = "header") %>%
  flextable::align_text_col(align = "center") %>%
  flextable::set_caption(caption = "Overview of the newordata.")  %>%
  flextable::border_outer()
```
