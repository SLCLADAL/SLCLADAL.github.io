...
# install libraries
install.packages(c("Boruta", "caret", "cowplot", "dplyr", "flextable",
                   "ggparty", "ggplot2", "Gmisc", "grid", "Hmisc", 
...
Schweinberger, Martin. 2020. *Tree-Based Models in R*. Brisbane: The University of Queensland. url: https://slcladal.github.io/advancedstatztrees.html (Version 2020.12.03).
