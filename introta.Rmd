...
```{r colloc, echo=FALSE, out.width= "60%", out.extra='style="float:right; padding:10px"'}
...
Natural language processing is an interdisciplinary field in computer science that has specialized on processing natural language data using computational and mathematical methods. Many methods used in Text Analysis have been developed in NLP.
