...
The bi-plot shows that "natural" and "selection" collocate, as do "life" and "conditions", "distinct" and "species" as well as "two" and "varieties". Other words with lower collocation strength are masked from the bi-plot. 
