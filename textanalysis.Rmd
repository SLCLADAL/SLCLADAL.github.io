...
```{r Fig2, fig.width=8, fig.height=6, echo=FALSE, warning=FALSE, fig.cap="\\label{fig:Fig1} Comparative network graph for personas in William Shakespeare's King Lear, Macbeth, and Orthello. (from http://www.martingrandjean.ch/network-visualization-shakespeare/."}
library(png)
