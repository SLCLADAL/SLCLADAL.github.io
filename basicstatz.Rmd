...
# inspect data
datatable(coolmatrix, rownames = FALSE, filter="top", options = list(pageLength = 5, scrollX=T))
```
...
A hierarchical alternative to CFA is Hierarchical Configural Frequency Analysis (HCFA). In contrast to CFA, in HCFA, the data is assumed to be nested!
...
Schweinberger, Martin. 2020. *Basic Inferential Statistics with R*. Brisbane: The University of Queensland. url: https://slcladal.github.io/basicstatzchi.html.
