...
This tutorial introduces basic statistical techniques for inferential statistics for hypothesis testing. The first part of this section focuses on basic non-parametric  tests such as Fisher's Exact test while the second part introduces parametric tests such as the t-test. 
