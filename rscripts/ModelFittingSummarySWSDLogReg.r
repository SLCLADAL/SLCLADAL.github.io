...
### --- saturated model including all main effects and interactions
...
###############################################################
### Function for a neat output table for model comparisons
### during step-wise step-down model fitting
###############################################################
mdl.fttng.swsd.blr <- function(mdlcmps){
...
colnames(mdl.cmp.df2) <- c( "Formula", "Term Removed", "Compared to...", "DF", "Residual Deviance", "p-value", "Significance")
...
#mdlcmp <- list(m8.m7, m7.m6, m6.m5)
# apply function
#test <- mdl.fttng.swsd.blr(mdlcmp)
# inspect results
#test
